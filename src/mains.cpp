        ...
        if (event == "telemetry") {
          ...
          for (int i = 0; i < sensor_fusion.size(); i += 1) {
            ...
            if (car_lane == lane) {
              ...
              // Right ?
              car_right = car_right || (car_s - 30 < check_car_s &&
          ...
          // 30m Then interpolate these waypoints with a spline
          vector<double> ptsx;
          vector<double> ptsy;

          // Reference x, y and yaw states
          // Either use starting point or previous end point as to where the car
          // is
          double ref_x = car_x;
          double ref_y = car_y;
          ...
          // Calculate the break up spline points to travel at reference
          // velocity
